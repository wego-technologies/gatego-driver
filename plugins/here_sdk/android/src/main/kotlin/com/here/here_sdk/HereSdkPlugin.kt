    ...
    companion object {
        ...
        private fun calculateOptions(args: Any?): MapViewOptions? {
            ...
            if ( args != null &&
                ...
                options = when {
                    projection == false -> MapViewOptions(MapProjection.WEB_MERCATOR, color)
                    projection == true -> MapViewOptions(MapProjection.GLOBE, color)
                    color != null -> MapViewOptions(color)
                    else -> null
                }
            }
            return options
