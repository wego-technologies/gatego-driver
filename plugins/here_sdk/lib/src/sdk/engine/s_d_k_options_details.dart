...
abstract class SDKOptionsDetails {
  ...
  /// [SDKNativeEngine]
  ///
  /// Returns [SDKOptions]. Convered internal options
  ///
  /// @nodoc
  static SDKOptions internalmakeInternal(SDKOptions publicOptions) => $prototype.internalmakeInternal(publicOptions);
...
class SDKOptionsDetails$Impl extends __lib.NativeBase implements SDKOptionsDetails {
  ...
  SDKOptions internalmakeInternal(SDKOptions publicOptions) {
