...
/// Use the TrafficEngine to get information about current traffic
/// incidents in an area specified by [GeoBox], [GeoCircle], or [GeoCorridor].
///
/// Provide optional parameters like an incident impact for severity attributes,
/// an incident type along with others to filter the results.
///
...
abstract class TrafficEngine {
  ...
  /// The maximum length for the corridor is 500000 meters and the maximum radius is 5000 meters.
  ///
  /// [queryOptions] The options which are specific for incidents query.
  ///
  /// [callback] It is always invoked on the main thread.
