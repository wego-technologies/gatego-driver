...
class LocationInternal {
  ...
  @Deprecated("Will be removed in v4.11.0. Use [Location.time] instead.")
  DateTime timestamp;
  ...
  LocationInternal(this.coordinates, this.bearingInDegrees, this.speedInMetersPerSecond, this.timestamp, this.time, this.horizontalAccuracyInMeters, this.verticalAccuracyInMeters, this.bearingAccuracyInDegrees, this.speedAccuracyInMetersPerSecond, this.timestampSinceBootInMilliseconds);
  LocationInternal.withDefaults(GeoCoordinates coordinates)
    : coordinates = coordinates, bearingInDegrees = null, speedInMetersPerSecond = null, timestamp = DateTime.fromMillisecondsSinceEpoch(0), time = null, horizontalAccuracyInMeters = null, verticalAccuracyInMeters = null, bearingAccuracyInDegrees = null, speedAccuracyInMetersPerSecond = null, timestampSinceBootInMilliseconds = null;
}
...
final _sdkCoreLocationCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint64, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>)
