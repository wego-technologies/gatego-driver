...
class AuthenticationData {
  ...
  /// Defaults to 0.
  @Deprecated("Will be removed in v4.13.0. Use [AuthenticationData.expiryTime] instead.")
  ...
  AuthenticationData._(this.token, this.expiryTimeInSeconds, this.expiryTime);
  @Deprecated("Will be removed in v4.13.0. Please use AuthenticationData.withDefaults() instead.")
  AuthenticationData(this.token, this.expiryTimeInSeconds)
      : expiryTime = const Duration(seconds: 0);
  AuthenticationData.withDefaults()
      : token = "", expiryTimeInSeconds = 0, expiryTime = const Duration(seconds: 0);
  @override
...
final _sdkCoreAuthenticationdataCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Uint64, Uint64),
...
Pointer<Void> sdkCoreAuthenticationdataToFfi(AuthenticationData value) {
  ...
  final _result = _sdkCoreAuthenticationdataCreateHandle(_tokenHandle, _expiryTimeInSecondsHandle, _expiryTimeHandle);
