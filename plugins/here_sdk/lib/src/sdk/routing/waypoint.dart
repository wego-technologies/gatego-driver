...
class Waypoint {
  ...
  @Deprecated("Will be removed in v4.13.0. Use [Waypoint.duration] instead.")
  ...
  Waypoint(GeoCoordinates coordinates, [WaypointType type = WaypointType.stopover, int transitRadiusInMeters = 0, int durationInSeconds = 0, double? headingInDegrees = null, GeoCoordinates? sideOfStreetHint = null, int? minCourseDistanceInMeters = null, String? nameHint = null, MatchSideOfStreet? matchSideOfStreet = null, Duration duration = const Duration(seconds: 0)])
    : coordinates = coordinates, type = type, transitRadiusInMeters = transitRadiusInMeters, durationInSeconds = durationInSeconds, headingInDegrees = headingInDegrees, sideOfStreetHint = sideOfStreetHint, minCourseDistanceInMeters = minCourseDistanceInMeters, nameHint = nameHint, matchSideOfStreet = matchSideOfStreet, duration = duration;
  Waypoint.withDefaults(GeoCoordinates coordinates)
    : coordinates = coordinates, type = WaypointType.stopover, transitRadiusInMeters = 0, durationInSeconds = 0, headingInDegrees = null, sideOfStreetHint = null, minCourseDistanceInMeters = null, nameHint = null, matchSideOfStreet = null, duration = const Duration(seconds: 0);
  @override
...
final _sdkRoutingWaypointCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Uint32, Int32, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint64),
    Pointer<Void> Function(Pointer<Void>, int, int, int, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, int)
...
Pointer<Void> sdkRoutingWaypointToFfi(Waypoint value) {
  ...
  final _result = _sdkRoutingWaypointCreateHandle(_coordinatesHandle, _typeHandle, _transitRadiusInMetersHandle, _durationInSecondsHandle, _headingInDegreesHandle, _sideOfStreetHintHandle, _minCourseDistanceInMetersHandle, _nameHintHandle, _matchSideOfStreetHandle, _durationHandle);
