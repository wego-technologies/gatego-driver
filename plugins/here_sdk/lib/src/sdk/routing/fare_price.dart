...
class FarePrice {
  ...
  /// Defaults to `null`.
  @Deprecated("Will be removed in v4.13.0. Use [FarePrice.validityPeriod] instead.")
  ...
  FarePrice._(this.type, this.estimated, this.currency, this.validityPeriodInSeconds, this.minimum, this.maximum, this.validityPeriod);
  @Deprecated("Will be removed in v4.13.0. Please use FarePrice.withDefaults() instead.")
  FarePrice(this.type, this.estimated, this.currency, this.validityPeriodInSeconds, this.minimum, this.maximum)
      : validityPeriod = null;
  FarePrice.withDefaults()
      : type = FarePriceType.value, estimated = false, currency = "EUR", validityPeriodInSeconds = null, minimum = 0, maximum = 0, validityPeriod = null;
}
...
final _sdkRoutingFarepriceCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32, Uint8, Pointer<Void>, Pointer<Void>, Double, Double, Pointer<Void>),
    Pointer<Void> Function(int, int, Pointer<Void>, Pointer<Void>, double, double, Pointer<Void>)
...
Pointer<Void> sdkRoutingFarepriceToFfi(FarePrice value) {
  ...
  final _result = _sdkRoutingFarepriceCreateHandle(_typeHandle, _estimatedHandle, _currencyHandle, _validityPeriodInSecondsHandle, _minimumHandle, _maximumHandle, _validityPeriodHandle);
