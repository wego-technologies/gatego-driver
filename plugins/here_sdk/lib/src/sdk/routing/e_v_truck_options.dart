...
class EVTruckOptions {
  ...
  EVTruckOptions._(this.routeOptions, this.textOptions, this.avoidanceOptions, this.specifications, this.tunnelCategory, this.linkTunnelCategory, this.hazardousGoods, this.hazardousMaterials, this.consumptionModel);
  EVTruckOptions.withDefaults()
      : routeOptions = RouteOptions.withDefaults(), textOptions = RouteTextOptions.withDefaults(), avoidanceOptions = AvoidanceOptions.withDefaults(), specifications = TruckSpecifications(), tunnelCategory = null, linkTunnelCategory = null, hazardousGoods = [], hazardousMaterials = [], consumptionModel = EVConsumptionModel.withDefaults();
  ...
  EVTruckOptions(this.routeOptions, this.textOptions, this.avoidanceOptions, this.specifications, this.tunnelCategory, this.hazardousGoods, this.consumptionModel)
      : linkTunnelCategory = null, hazardousMaterials = [];
  @override
...
Pointer<Void> sdkRoutingEvtruckoptionsToFfi(EVTruckOptions value) {
  ...
  final _result = _sdkRoutingEvtruckoptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _specificationsHandle, _tunnelCategoryHandle, _linkTunnelCategoryHandle, _hazardousGoodsHandle, _hazardousMaterialsHandle, _consumptionModelHandle);
