...
class BatterySpecifications {
  ...
  /// Defaults to 0.
  @Deprecated("Will be removed in v4.13.0. Use [BatterySpecifications.chargingSetupDuration] instead.")
...
final _sdkRoutingBatteryspecificationsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Double, Double, Double, Pointer<Void>, Pointer<Void>, Double, Double, Pointer<Void>, Pointer<Void>, Int32, Uint64),
    Pointer<Void> Function(double, double, double, Pointer<Void>, Pointer<Void>, double, double, Pointer<Void>, Pointer<Void>, int, int)
