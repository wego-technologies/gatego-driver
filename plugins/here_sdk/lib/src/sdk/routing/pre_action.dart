...
class PreAction {
  ...
  /// Defaults to 0.
  @Deprecated("Will be removed in v4.13.0. Use [PreAction.duration] instead.")
  ...
  PreAction._(this.action, this.durationInSeconds, this.duration);
  @Deprecated("Will be removed in v4.13.0. Please use PreAction.withDefaults() instead.")
  PreAction(this.action, this.durationInSeconds)
      : duration = const Duration(seconds: 0);
  PreAction.withDefaults()
      : action = PreActionType.board, durationInSeconds = 0, duration = const Duration(seconds: 0);
  @override
...
Pointer<Void> sdkRoutingPreactionToFfi(PreAction value) {
  ...
  final _result = _sdkRoutingPreactionCreateHandle(_actionHandle, _durationInSecondsHandle, _durationHandle);
