...
class TransitStop {
  ...
  /// are on board.
  /// Defaults to `null`.
  @Deprecated("Will be removed in v4.13.0. Use [TransitStop.duration] instead.")
  ...
  TransitStop._(this.departure, this.durationInSeconds, this.duration);
  @Deprecated("Will be removed in v4.13.0. Please use TransitStop.withDefaults() instead.")
  TransitStop(this.departure, this.durationInSeconds)
      : duration = null;
  TransitStop.withDefaults(this.departure)
      : durationInSeconds = null, duration = null;
}
...
Pointer<Void> sdkRoutingTransitstopToFfi(TransitStop value) {
  ...
  final _result = _sdkRoutingTransitstopCreateHandle(_departureHandle, _durationInSecondsHandle, _durationHandle);
