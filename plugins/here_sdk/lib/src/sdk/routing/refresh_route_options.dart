...
abstract class RefreshRouteOptions {
  ...
  ///
  factory RefreshRouteOptions.withTransportMode(sdk_transport.TransportMode transportMode) => $prototype.withTransportMode(transportMode);
...
class RefreshRouteOptions$Impl extends __lib.NativeBase implements RefreshRouteOptions {
  ...
  RefreshRouteOptions withTransportMode(sdk_transport.TransportMode transportMode) {
  ...
  static Pointer<Void> _withTransportMode(sdk_transport.TransportMode transportMode) {
