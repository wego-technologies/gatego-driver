...
class GeoPlace {
  ...
  /// @nodoc
  @internal
  bool internalmyPlace;

  GeoPlace.withDefaults()
      : title = "", externalIDs = [], type = PlaceType.unknown, categories = [], address = Address(), location = null, business = BusinessDetails(), web = WebDetails(), internalid = "", internalmyPlace = false;
  @Deprecated("Will be removed in v4.13.0. Please use `withDefaults()` constructor instead.")
  GeoPlace(this.title, this.externalIDs, this.type, this.categories, this.address, this.location, this.business, this.web)
      : internalid = "", internalmyPlace = false;
  @Deprecated("Will be removed in v4.13.0. Please use `withDefaults()` constructor instead.")
  GeoPlace.allFields(this.title, this.externalIDs, this.type, this.categories, this.address, this.location, this.business, this.web, this.internalid, this.internalmyPlace);
  ...
  bool operator ==(Object other) {
    ...
    return title == _other.title &&
        ...
        internalmyPlace == _other.internalmyPlace;
  }
  ...
  int get hashCode {
    ...
    result = 31 * result + internalmyPlace.hashCode;
    return result;
  }
...
Pointer<Void> sdkSearchGeoplaceToFfi(GeoPlace value) {
  ...
  final _myPlaceHandle = booleanToFfi(value.internalmyPlace);
