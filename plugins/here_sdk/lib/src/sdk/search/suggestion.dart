...
class Suggestion$Impl extends __lib.NativeBase implements Suggestion {
  ...
  @override
  set internalexperimental(SuggestionExperimental? value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_search_Suggestion_experimental_set__SuggestionExperimental_'));
