...
abstract class HereMapControllerCore {
  ...
  /// Adds a listener for receiving idle state notifications.
  ///
  /// The new listener
  /// is appended to the set of `HereMap` idle listeners as a strong reference. The caller is responsible for
  /// releasing the strong reference by calling `removeIdleListener`.
  /// The map is to be considered as idle until the listener gets notified of map transitioning to the busy state.
  /// Initial busy state transition could be notified multiple times.
