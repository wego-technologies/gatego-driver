...
abstract class MapLayerBuilder {
  ...
  /// Configures the builder to set the layer visible in the given range.
  ///
...
final _buildReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapLayerBuilder_build_return_release_handle'));
final _buildReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapLayerBuilder_build_return_get_result'));
final _buildReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapLayerBuilder_build_return_get_error'));
final _buildReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
class MapLayerBuilder$Impl extends __lib.NativeBase implements MapLayerBuilder {
  ...
  @override
  MapLayerBuilder withDataSource(String dataSourceName, MapContentType contentType) {
    final _withDataSourceFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32, Pointer<Void>, Uint32), Pointer<Void> Function(Pointer<Void>, int, Pointer<Void>, int)>('here_sdk_sdk_mapview_MapLayerBuilder_withDataSource__String_MapContentType'));
    final _dataSourceNameHandle = stringToFfi(dataSourceName);
    final _contentTypeHandle = sdkMapviewMapcontenttypeToFfi(contentType);
    final _handle = this.handle;
    ...
    sdkMapviewMapcontenttypeReleaseFfiHandle(_contentTypeHandle);
    try {
      return sdkMapviewMaplayerbuilderFromFfi(__resultHandle);
    } finally {
      sdkMapviewMaplayerbuilderReleaseFfiHandle(__resultHandle);
  ...
  MapLayer build() {
    ...
    if (_buildReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _buildReturnGetError(__callResultHandle);
        _buildReturnReleaseHandle(__callResultHandle);
        try {
    ...
    final __resultHandle = _buildReturnGetResult(__callResultHandle);
    _buildReturnReleaseHandle(__callResultHandle);
    try {
