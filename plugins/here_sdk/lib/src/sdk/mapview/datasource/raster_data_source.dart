...
abstract class RasterDataSource {
  /// Creates a RasterDataSource instance with the provided data source configuration file.
  ///
  /// [context] The map context to associate the data source with.
  ///
  /// [configFile] The path to the data source configuration file.
  ///
  /// @nodoc
  factory RasterDataSource.withConfigFile(MapContext context, String configFile) => $prototype.internalwithConfigFile(context, configFile);
  /// Creates a RasterDataSource instance with the provided data source configuration file and
  ...
  ///
  /// @nodoc
  factory RasterDataSource.withConfigFileAndListener(MapContext context, String configFile, RasterDataSourceListener listener) => $prototype.internalwithConfigFileAndListener(context, configFile, listener);
  ...
  /// Applies the new configuration to the datasource.
  ///
  /// [configFile] The path to the data source configuration file. E.g. "maptile.datasource.json".
  ///
  @Deprecated("Will be removed in v4.13.0.")

  void changeConfigurationWithConfigPath(String configFile);
...
class RasterDataSource$Impl extends __lib.NativeBase implements RasterDataSource {
  ...
  RasterDataSource internalwithConfigFile(MapContext context, String configFile) {
    final _result_handle = _withConfigFile(context, configFile);
  ...
  RasterDataSource internalwithConfigFileAndListener(MapContext context, String configFile, RasterDataSourceListener listener) {
    final _result_handle = _withConfigFileAndListener(context, configFile, listener);
    final _result = RasterDataSource$Impl(_result_handle);
  ...
  static Pointer<Void> _withConfigFile(MapContext context, String configFile) {
    final _withConfigFileFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_mapview_datasource_RasterDataSource_create__MapContext_String'));
    final _contextHandle = sdkMapviewMapcontextToFfi(context);
    final _configFileHandle = stringToFfi(configFile);
    final __resultHandle = _withConfigFileFfi(__lib.LibraryContext.isolateId, _contextHandle, _configFileHandle);
    sdkMapviewMapcontextReleaseFfiHandle(_contextHandle);
    stringReleaseFfiHandle(_configFileHandle);
    return __resultHandle;
  }

  static Pointer<Void> _withConfigFileAndListener(MapContext context, String configFile, RasterDataSourceListener listener) {
    final _withConfigFileAndListenerFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_mapview_datasource_RasterDataSource_create__MapContext_String_RasterDataSourceListener'));
    final _contextHandle = sdkMapviewMapcontextToFfi(context);
    final _configFileHandle = stringToFfi(configFile);
    final _listenerHandle = sdkMapviewDatasourceRasterdatasourcelistenerToFfi(listener);
    final __resultHandle = _withConfigFileAndListenerFfi(__lib.LibraryContext.isolateId, _contextHandle, _configFileHandle, _listenerHandle);
    sdkMapviewMapcontextReleaseFfiHandle(_contextHandle);
    stringReleaseFfiHandle(_configFileHandle);
  ...
  @override
  void changeConfigurationWithConfigPath(String configFile) {
    final _changeConfigurationWithConfigPathFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_datasource_RasterDataSource_changeConfiguration__String'));
    final _configFileHandle = stringToFfi(configFile);
    final _handle = this.handle;
    _changeConfigurationWithConfigPathFfi(_handle, __lib.LibraryContext.isolateId, _configFileHandle);
    stringReleaseFfiHandle(_configFileHandle);
