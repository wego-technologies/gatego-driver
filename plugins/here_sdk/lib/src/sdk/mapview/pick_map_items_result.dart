...
class PickMapItemsResult$Impl extends __lib.NativeBase implements PickMapItemsResult {
  ...
  List<MapMarkerClusterGrouping> get clusteredMarkers {
    ...
    try {
      return heresdkMapviewHarpBindingslistofSdkMapviewMapmarkerclusterGroupingFromFfi(__resultHandle);
    } finally {
      heresdkMapviewHarpBindingslistofSdkMapviewMapmarkerclusterGroupingReleaseFfiHandle(__resultHandle);
  ...
  List<MapMarker> get markers {
    ...
    final __resultHandle = _getFfi(_handle, __lib.LibraryContext.isolateId);
    try {
      return heresdkMapviewHarpBindingslistofSdkMapviewMapmarkerFromFfi(__resultHandle);
    } finally {
      heresdkMapviewHarpBindingslistofSdkMapviewMapmarkerReleaseFfiHandle(__resultHandle);
  ...
  List<MapPolyline> get polylines {
    ...
    final __resultHandle = _getFfi(_handle, __lib.LibraryContext.isolateId);
    try {
      return heresdkMapviewHarpBindingslistofSdkMapviewMappolylineFromFfi(__resultHandle);
    } finally {
      heresdkMapviewHarpBindingslistofSdkMapviewMappolylineReleaseFfiHandle(__resultHandle);
  ...
  List<MapPolygon> get polygons {
    ...
    final __resultHandle = _getFfi(_handle, __lib.LibraryContext.isolateId);
    try {
      return heresdkMapviewHarpBindingslistofSdkMapviewMappolygonFromFfi(__resultHandle);
    } finally {
      heresdkMapviewHarpBindingslistofSdkMapviewMappolygonReleaseFfiHandle(__resultHandle);
