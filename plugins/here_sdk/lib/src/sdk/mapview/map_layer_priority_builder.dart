...
/// to be unique within a layer. The layer's default, main category is unnamed. One way to define layers'
/// priorities is by using a layer priority list in the scene configuration.
///
...
/// ```
///
/// In case an empty MapLayerPriority without any ordering commands is built, or if a reference
/// layer-category pair is not present in the rendering order, it is assumed that the target layer
